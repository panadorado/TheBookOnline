    ...
    public class BookDatabaseInitializer : DropCreateDatabaseAlways<BookContext>
    {
        ...
        private static List<Category> GetCategories()
        {
            var categories = new List<Category>
            {
                ...
                new Category { CategoryID = 2, CategoryName = "Biographies and Memoirs" },
                new Category { CategoryID = 3, CategoryName = "Biological Sciences" },
        ...
        private static List<Book> GetBooks()
        {
            var books = new List<Book>
            {
                ...
                new Book
                {
                    ...
                    Description = "In this authoritative and engrossing full-scale biography, Walter Isaacson, " +
                ...
                new Book
                {
                    ...
                    Description = "During Barack Obama's two terms, Pete Souza was with the President " +
                    "during more crucial moments than anyone else--and he photographed them all",
                    ImagePath ="Pic3.png",
                    UnitPrice = 26.73f,
                    CategoryID = 2
                },
                ...
                new Book
                {
                    ...
                    Description = "One hundred thousand years ago, at least six different species of " +
